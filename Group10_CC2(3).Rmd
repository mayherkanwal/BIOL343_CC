...
----------------|----------------------------------|------
population_type |asexual or sexual                 | unitless
ovary_width     |width of ovary                    | mm
ovary_height    |height of ovary                   | mm
flower_number   |number of flowers per population  | #
...
```{r import-clean}
cc1data <- read.csv("./data/A1_Data_Excel(2).csv")
cc1_data <- cc1data[1:46, 1:8]
...
ggplot(cc1_data, aes(x=ovary_area))+geom_histogram(binwidth=1)+facet_wrap(~population_type)+labs(x="ovary area(mm^2)",y="count",title="Ovary Area by population type")+theme_classic()
```
